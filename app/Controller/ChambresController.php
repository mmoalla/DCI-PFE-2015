...
class ChambresController extends AppController {
    ...
    public function admin_add() {
        if ($this->request->is('post')) {
            ...
            if ($this->Chambre->save($this->request->data)) {
                $this->historique("L'administrateur " . $this->Auth->user('prenom') . ' ' . $this->Auth->user('nom') . " a ajouté une nouvelle chambre");
    ...
    public function admin_delete($id = null) {
        ...
        if ($this->Chambre->delete()) {
            $this->historique("L'administrateur " . $this->Auth->user('prenom') . ' ' . $this->Auth->user('nom') . " a supprimé une chambre ");
